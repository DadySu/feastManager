...
public class SecurityUtil {
	...
	private static final String securityCode = "uItsEJWzaJtNHH1ipe2hSy3mcEIFzAcD";

	public static boolean matchPassword(final String maskedPassword,
			final String salt, final String password) {
		boolean result = calcMaskedPassword(salt, password).equalsIgnoreCase(
				maskedPassword);
		return result;
	}

...
public class ReflectionUtils
{
    ...
    public static Object invokeGetterMethod(Object target, String propertyName)
    {
    	...
    	if(propertyName.contains(".")){
    		...
    		String className=propertyNames[0];
    		propertyName=propertyNames[1];
    		String getterMethodName = "get" + StringUtils.capitalize(className);
    		target=invokeMethod(target, getterMethodName,  propertyName,new Class[] {},
                    new Object[] {});
    	}
        String getterMethodName = "get" + StringUtils.capitalize(propertyName);
        return invokeMethod(target, getterMethodName,propertyName, new Class[] {},
                new Object[] {});
    }
